...
class PluginAPI {
  ...
  addDependency(name) {
    ...
    if (dep) {
      ...
      console.log();
      console.log(chalk.red(`Please add ${dep} to create-strv-app package.json dependencies.`));
    }
  }
  ...
  addDevDependency(name) {
    ...
    if (dep) {
      ...
      console.log();
      console.log(chalk.red(`Please add ${dep} to create-strv-app package.json devDependencies.`));
    }
  }
