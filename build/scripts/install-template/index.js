...
exports.installTemplate = function (targetDir) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, fs_extra_1.default.copy(path_1.default.join(process.cwd(), 'templates/'), path_1.default.join(targetDir, 'templates/'))];
            case 2:
                _a.sent();
            ...
            case 3:
                _a.sent();
                return [4 /*yield*/, fs_extra_1.default.copy(path_1.default.join(process.cwd(), 'scripts/install-template.js'), path_1.default.join(targetDir, 'scripts/install-template/index.js'))];
            case 4:
                _a.sent();
                return [2 /*return*/];
        }
