...
exports.cypress = function (workspace, targetDir, name) {
    if (name === void 0) { name = 'cypress'; }
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fs_extra_1.default
                            .copy(path_1.default.join(process.cwd(), 'templates/cypress'), p)
                            .then(function () {
                            ...
                            pkg.addScript((_a = {},
                                _a["start:" + name] = "(cd packages/" + name + " && yarn start)",
                                _a));
                            return pkg.save();
                        })];
                case 1:
