...
exports.next = function (workspace, targetDir, name) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    var p;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fs_extra_1.default
                        .copy(path_1.default.join(process.cwd(), 'templates/next'), p)
                        .then(function () {
